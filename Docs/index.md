...
# TEMPTARE[^1]
<iframe width="560" height="315" src="https://www.youtube.com/embed/iVY4b_V9NLc?si=vrloGeE0IZn09-kS"></iframe>

## Description
Temptare is a Virtual Reality first person shooter that teaches gun safety through interactive gameplay. The player has the option to play in a training course where they must shoot enemy targets, avoid shooting friendly targets, and handle their gun with care. The game is designed to be both educational and entertaining, with the goal of improving gun safety knowledge and decision-making skills. The player does not have to move themself through the training course, they are automatically moved through the course to reduce motion sickness. The game was developed using Unity and C# and is intended to be played on a VR headset.
